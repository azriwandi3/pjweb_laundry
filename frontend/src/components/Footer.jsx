                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <span className="text-xl font-bold text-white">LaundryKu</span>
                        </div>
                        <p className="text-gray-400 max-w-md">
                            Layanan laundry terpercaya dengan kualitas terbaik. Kami menjemput, mencuci, dan mengantar pakaian Anda dengan cepat dan bersih.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link to="/services" className="hover:text-primary-400 transition-colors">Layanan</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li className="flex items-center space-x-2">
                                <span>📍</span>
                                <span>Jl. Laundry No. 123, Mataram</span>
                            </li>
                            <li className="flex items-center space-x-2">
                                <span>📞</span>
                            ...
                            <li className="flex items-center space-x-2">
                                <span>✉️</span>
                                <span>infoazrycs@laundryku.com</span>
                            </li>
                            <li className="flex items-center space-x-2">
                                <span>⏰</span>
